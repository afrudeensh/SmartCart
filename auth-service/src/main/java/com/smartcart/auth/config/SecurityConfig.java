...
import com.smartcart.auth.service.UserDetailsServiceImpl;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                // ── Custom error responses (bypasses @RestControllerAdvice) ───────
                .exceptionHandling(ex -> ex
                        ...
                        .authenticationEntryPoint((request, response, authException) -> {
                            ...
                            objectMapper.writeValue(
                                    response.getWriter(),
                                    BaseResponse.error(401, "Authentication required: " + authException.getMessage())
                            );
                        })
                        ...
                        .accessDeniedHandler((request, response, accessDeniedException) -> {
                            ...
                            objectMapper.writeValue(
                                    response.getWriter(),
                                    BaseResponse.error(403, "Access denied: insufficient permissions")
                            );
                        })
                );
